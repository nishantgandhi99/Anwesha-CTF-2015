<%-- 
    ...
    Created on : Jan 31, 2014, 3:15:06 PM
    Author     : nishant
--%>
...
<html lang="en">
    ...
    <body  style=" background-color: #000">
        ...
        <div class="jumbotron"  style="background-color: black">
            <div class="container">
                <center> <h1 class="greentext">Time to do some Assembly work</h1></center><br/>
                <center> <h3 style=" color: red">Crack the code for extract/print flag in given executable file.</h3></center>
        ...
        <p class="greentext">
            ...
            Hint:use online disassembler.
            <a href="string.exe">Download From Here</a>
        </p>
