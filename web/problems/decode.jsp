<%-- 
    Document   : FindText
    Created on : Jan 31, 2014, 7:56:34 PM
    Author     : nishant
--%>
...
<html lang="en">
    ...
    <body  style=" background-color: #000">
        ...
        <div class="jumbotron"  style="background-color: black">
            <div class="container">
                <center> <h1 class="greentext">Now something for Linux Geeks</h1></center><br/>
                <center> <h3 style=" color: red">Find the flag</h3></center>
                <br/><br/><br/>              
                <center>  
                    <p class="greentext">

                        Login to Linux Server using SSH: <br/>
                        IP:172.16.16.119<br/>
                        Username:ctf<br/>
                        Password:ctf1234<br/>
                        Problem: goto "/var/Problem2" Find the file in that folder which contain Flag
                        <br/>
                </center>
            </div>
        </div>
