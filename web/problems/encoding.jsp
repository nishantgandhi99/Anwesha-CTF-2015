<%-- 
    Document   : encoding
    Created on : Jan 31, 2014, 6:37:44 PM
    Author     : nishant
--%>
...
<html lang="en">
    ...
    <body  style=" background-color: #000">
        ...
        <div class="jumbotron"  style="background-color: black">
            <div class="container">
                <center> <h1 class="greentext">Let see how much you know codes</h1></center><br/>
                <center> <h3 style=" color: red">Find the flag</h3></center>
                <br/><br/><br/>
                <p class="greentext">
                    <!-- decode("59%6F%75%20%4D%61%64%65%20%49%74%3A%46%6C%61%67%3D%22%43%68%61%72%61%63%74%65%72%5F%53%65%74%5F%53%75%63%6B%73%22")-->
                </p>       
            </div>
        </div>
        <!-- /container -->
